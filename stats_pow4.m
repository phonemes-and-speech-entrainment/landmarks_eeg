...
pow4_da=mean(pow4(:,[1 2 3 7 8 9 13]),2);
pow4_ta=mean(pow4(:,[4 5 6 10 11 12 14]),2);

[h,p1]=ttest(pow4_da,pow4_ta);
...
pow4_da_white=mean(pow4(:,7:9),2);
pow4_ta_white=mean(pow4(:,10:12),2);

[h,p2]=ttest(pow4_da_white,pow4_ta_white);
...
pow4_da_disc=mean(pow4(:,1:3),2);
pow4_ta_disc=mean(pow4(:,4:6),2);

[h,p3]=ttest(pow4_da_disc,pow4_ta_disc);
...
pow4_da_onset=mean(pow4(:,[1,7]),2);
pow4_ta_onset=mean(pow4(:,[4 10]),2);

[h,p4]=ttest(pow4_da_onset,pow4_ta_onset);
...
pow4_da_cv=mean(pow4(:,[2,8]),2);
pow4_ta_cv=mean(pow4(:,[5 11]),2);

[h,p5]=ttest(pow4_da_cv,pow4_ta_cv);  
...
pow4_da_max=mean(pow4(:,[3,9]),2);
pow4_ta_max=mean(pow4(:,[6 12]),2);

[h,p6]=ttest(pow4_da_max,pow4_ta_max);
...
pow4_disc=mean(pow4(:,1:6),2);
pow4_white=mean(pow4(:,7:12),2);
pow4_cont=mean(pow4(:,[13 14]),2);

pow4_1=[pow4_disc,pow4_white,pow4_cont];

p7=anova1(pow4_1,groups_1);
...
pow4_0=mean(pow4(:,[1 4 7 10]),2);
pow4_cv=mean(pow4(:,[2 5 8 11]),2);
pow4_maxmp=mean(pow4(:,[3 6 9 12]),2);

pow4_loc=[pow4_0,pow4_cv,pow4_maxmp,pow4_cont];

groups2={'onset','cv','maxamp','control'};

p8=anova1(pow4_loc,groups2);
...
itc_disc_onset=mean(pow4(:,[1,4]),2);
itc_white_onset=mean(pow4(:,[7,10]),2);
itc_control=mean(pow4(:,13:14),2);
...
itc_disc_cv=mean(pow4(:,[2,5]),2);
itc_white_cv=mean(pow4(:,[8,11]),2);
...
itc_disc_max=mean(pow4(:,[3,6]),2);
itc_white_max=mean(pow4(:,[9,12]),2);
...
itc_da_disc=mean(pow4(:,1:3),2);
itc_da_white=mean(pow4(:,7:9),2);

groups_da_noise={'da disc', 'da white', 'da control'};

p12=anova1([itc_da_disc,itc_da_white,pow4(:,13)], groups_da_noise);
...
itc_ta_disc=mean(pow4(:,4:6),2);
itc_ta_white=mean(pow4(:,10:12),2);

groups_ta_noise={'da disc', 'da white', 'da control'};

p13=anova1([itc_ta_disc,itc_ta_white,pow4(:,13)], groups_ta_noise);
...
itc_da_onset=mean(pow4(:,[1 7]),2);
itc_da_cv=mean(pow4(:,[2 8]),2);
itc_da_maxamp=mean(pow4(:,[3 9]),2);

groups_da_location={'da onset', 'da cv', 'da maxamp', 'da control'};

p14=anova1([itc_da_onset,itc_da_cv,itc_da_maxamp,pow4(:,13)], groups_da_location);
...
[h,p]=ttest(itc_da_onset,pow4(:,13));    
...
itc_ta_onset=mean(pow4(:,[4 10]),2);
itc_ta_cv=mean(pow4(:,[5 11]),2);
itc_ta_maxamp=mean(pow4(:,[6 12]),2);

groups_ta_location={'ta onset', 'ta cv', 'ta maxamp', 'ta control'};

p15=anova1([itc_ta_onset,itc_ta_cv,itc_ta_maxamp,pow4(:,13)], groups_ta_location);
...
[h,p]=ttest(itc_ta_onset,pow4(:,13));
...
itc_disc_0=mean(pow4(:,[1,4]),2);
itc_disc_cv=mean(pow4(:,[2,5]),2);
itc_disc_maxamp=mean(pow4(:,[3,6]),2);
...
itc_white_0=mean(pow4(:,[7,10]),2);
itc_white_cv=mean(pow4(:,[8,11]),2);
itc_white_maxamp=mean(pow4(:,[9,12]),2);
...
p18=anova1(pow4(:,[1 2 3 13]), groups_da_disc);
...
p19=anova1(pow4(:,[4 5 6 14]), groups_ta_disc);
...
p20=anova1(pow4(:,[7 8 9 13]), groups_da_white);
...
p21=anova1(pow4(:,[10 11 12 14]), groups_ta_white);
...
p22=anova1(pow4(:,[1 7 13]), groups_da_0);
...
p23=anova1(pow4(:,[2 8 13]), groups_da_cv);
...
p24=anova1(pow4(:,[3 9 13]), groups_da_max_amp);
...
p25=anova1(pow4(:,[4 10 14]), groups_ta_0);
...
p26=anova1(pow4(:,[5 11 14]), groups_ta_cv);
...
p27=anova1(pow4(:,[6 12 14]), groups_ta_max_amp);
