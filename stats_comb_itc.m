...
itc_comb3_da=mean(itc_comb3(:,[1 2 3 7 8 9 13]),2);
itc_comb3_ta=mean(itc_comb3(:,[4 5 6 10 11 12 14]),2);

[h,p1]=ttest(itc_comb3_da,itc_comb3_ta);
...
itc_comb3_da_white=mean(itc_comb3(:,7:9),2);
itc_comb3_ta_white=mean(itc_comb3(:,10:12),2);

[h,p2]=ttest(itc_comb3_da_white,itc_comb3_ta_white);
...
itc_comb3_da_disc=mean(itc_comb3(:,1:3),2);
itc_comb3_ta_disc=mean(itc_comb3(:,4:6),2);

[h,p3]=ttest(itc_comb3_da_disc,itc_comb3_ta_disc);
...
itc_comb3_da_onset=mean(itc_comb3(:,[1,7]),2);
itc_comb3_ta_onset=mean(itc_comb3(:,[4 10]),2);

[h,p4]=ttest(itc_comb3_da_onset,itc_comb3_ta_onset);
...
itc_comb3_da_cv=mean(itc_comb3(:,[2,8]),2);
itc_comb3_ta_cv=mean(itc_comb3(:,[5 11]),2);

[h,p5]=ttest(itc_comb3_da_cv,itc_comb3_ta_cv);  %marginally significant, da>ta
...
itc_comb3_da_max=mean(itc_comb3(:,[3,9]),2);
itc_comb3_ta_max=mean(itc_comb3(:,[6 12]),2);

[h,p6]=ttest(itc_comb3_da_max,itc_comb3_ta_max);
...
itc_comb3_disc=mean(itc_comb3(:,1:6),2);
itc_comb3_white=mean(itc_comb3(:,7:12),2);
itc_comb3_cont=mean(itc_comb3(:,[13 14]),2);

itc_comb3_1=[itc_comb3_disc,itc_comb3_white,itc_comb3_cont];

p7=anova1(itc_comb3_1,groups_1);
...
itc_comb3_0=mean(itc_comb3(:,[1 4 7 10]),2);
itc_comb3_cv=mean(itc_comb3(:,[2 5 8 11]),2);
itc_comb3_maxmp=mean(itc_comb3(:,[3 6 9 12]),2);

itc_comb3_loc=[itc_comb3_0,itc_comb3_cv,itc_comb3_maxmp,itc_comb3_cont];

groups2={'onset','cv','maxamp','control'};

p8=anova1(itc_comb3_loc,groups2);
...
itc_disc_onset=mean(itc_comb3(:,[1,4]),2);
itc_white_onset=mean(itc_comb3(:,[7,10]),2);
itc_control=mean(itc_comb3(:,13:14),2);
...
itc_disc_cv=mean(itc_comb3(:,[2,5]),2);
itc_white_cv=mean(itc_comb3(:,[8,11]),2);
...
[h,p]=ttest(itc_disc_cv,itc_white_cv);   %marginally significant, disc_cv>white_cv (would be significant without control group, p=.02)

fprintf('The p-value of the t-test between disc_cv and white_cv groups is %f\n',p);

[h,p]=ttest(itc_disc_cv,itc_control);    %marginally significant, disc_cv>control

fprintf('The p-value of the t-test between disc_cv and control groups is %f\n',p);

[h,p]=ttest(itc_white_cv,itc_control);  
...
itc_disc_max=mean(itc_comb3(:,[3,6]),2);
itc_white_max=mean(itc_comb3(:,[9,12]),2);
...
itc_da_disc=mean(itc_comb3(:,1:3),2);
itc_da_white=mean(itc_comb3(:,7:9),2);

groups_da_noise={'da disc', 'da white', 'da control'};

p12=anova1([itc_da_disc,itc_da_white,itc_comb3(:,13)], groups_da_noise);
...
itc_ta_disc=mean(itc_comb3(:,4:6),2);
itc_ta_white=mean(itc_comb3(:,10:12),2);

groups_ta_noise={'da disc', 'da white', 'da control'};

p13=anova1([itc_ta_disc,itc_ta_white,itc_comb3(:,13)], groups_ta_noise);
...
itc_da_onset=mean(itc_comb3(:,[1 7]),2);
itc_da_cv=mean(itc_comb3(:,[2 8]),2);
itc_da_maxamp=mean(itc_comb3(:,[3 9]),2);

groups_da_location={'da onset', 'da cv', 'da maxamp', 'da control'};

p14=anova1([itc_da_onset,itc_da_cv,itc_da_maxamp,itc_comb3(:,13)], groups_da_location);
...
itc_ta_onset=mean(itc_comb3(:,[4 10]),2);
itc_ta_cv=mean(itc_comb3(:,[5 11]),2);
itc_ta_maxamp=mean(itc_comb3(:,[6 12]),2);

groups_ta_location={'ta onset', 'ta cv', 'ta maxamp', 'ta control'};

p15=anova1([itc_ta_onset,itc_ta_cv,itc_ta_maxamp,itc_comb3(:,13)], groups_ta_location);
...
itc_disc_0=mean(itc_comb3(:,[1,4]),2);
itc_disc_cv=mean(itc_comb3(:,[2,5]),2);
itc_disc_maxamp=mean(itc_comb3(:,[3,6]),2);
...
[h,p]=ttest(itc_disc_0,itc_disc_cv);

fprintf('The p-value of the t-test between disc_onset and disc_cv groups is %f\n',p);

[h,p]=ttest(itc_disc_0,itc_disc_maxamp);

fprintf('The p-value of the t-test between disc_onset and disc_maxamp groups is %f\n',p);

[h,p]=ttest(itc_disc_0,itc_control);

fprintf('The p-value of the t-test between disc_onset and control groups is %f\n',p);

[h,p]=ttest(itc_disc_cv,itc_disc_maxamp);

fprintf('The p-value of the t-test between disc_onset and disc_maxamp groups is %f\n',p);

[h,p]=ttest(itc_disc_cv,itc_control);

fprintf('The p-value of the t-test between disc_cv and control groups is %f\n',p);

[h,p]=ttest(itc_disc_maxamp,itc_control);
...
itc_white_0=mean(itc_comb3(:,[7,10]),2);
itc_white_cv=mean(itc_comb3(:,[8,11]),2);
itc_white_maxamp=mean(itc_comb3(:,[9,12]),2);
...
[h,p]=ttest(itc_white_maxamp,itc_control);
...
p18=anova1(itc_comb3(:,[1 2 3 13]), groups_da_disc);
...
p19=anova1(itc_comb3(:,[4 5 6 14]), groups_ta_disc);
...
p20=anova1(itc_comb3(:,[7 8 9 13]), groups_da_white);
...
p21=anova1(itc_comb3(:,[10 11 12 14]), groups_ta_white);
...
p22=anova1(itc_comb3(:,[1 7 13]), groups_da_0);
...
[h,p]=ttest(itc_comb3(:,1),itc_comb3(:,7));
...
p23=anova1(itc_comb3(:,[2 8 13]), groups_da_cv);
...
[h,p]=ttest(itc_comb3(:,2),itc_comb3(:,8));
...
p24=anova1(itc_comb3(:,[3 9 13]), groups_da_max_amp);
...
[h,p]=ttest(itc_comb3(:,3),itc_comb3(:,9));
...
p25=anova1(itc_comb3(:,[4 10 14]), groups_ta_0);
...
[h,p]=ttest(itc_comb3(:,4),itc_comb3(:,10));
...
p26=anova1(itc_comb3(:,[5 11 14]), groups_ta_cv);
...
[h,p]=ttest(itc_comb3(:,5),itc_comb3(:,11));
...
p27=anova1(itc_comb3(:,[6 12 14]), groups_ta_max_amp);
...
[h,p]=ttest(itc_comb3(:,6),itc_comb3(:,12));
