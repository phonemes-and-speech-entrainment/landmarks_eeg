...
[h,p2]=ttest(itc4_da_white,itc4_ta_white);
...
[h,p3]=ttest(itc4_da_disc,itc4_ta_disc);
...
[h,p4]=ttest(itc4_da_onset,itc4_ta_onset);
...
[h,p5]=ttest(itc4_da_cv,itc4_ta_cv);  %marginally significant, da>ta
...
[h,p6]=ttest(itc4_da_max,itc4_ta_max);
...
[h,p]=ttest(itc_da_onset,itc4(:,13));    
...
[h,p]=ttest(itc_ta_onset,itc4(:,13));
