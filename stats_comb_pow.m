...
pow_comb3_da=mean(pow_comb3(:,[1 2 3 7 8 9 13]),2);
pow_comb3_ta=mean(pow_comb3(:,[4 5 6 10 11 12 14]),2);

[h,p1]=ttest(pow_comb3_da,pow_comb3_ta);
...
pow_comb3_da_white=mean(pow_comb3(:,7:9),2);
pow_comb3_ta_white=mean(pow_comb3(:,10:12),2);

[h,p2]=ttest(pow_comb3_da_white,pow_comb3_ta_white);
...
pow_comb3_da_disc=mean(pow_comb3(:,1:3),2);
pow_comb3_ta_disc=mean(pow_comb3(:,4:6),2);

[h,p3]=ttest(pow_comb3_da_disc,pow_comb3_ta_disc);
...
pow_comb3_da_onset=mean(pow_comb3(:,[1,7]),2);
pow_comb3_ta_onset=mean(pow_comb3(:,[4 10]),2);

[h,p4]=ttest(pow_comb3_da_onset,pow_comb3_ta_onset);
...
pow_comb3_da_cv=mean(pow_comb3(:,[2,8]),2);
pow_comb3_ta_cv=mean(pow_comb3(:,[5 11]),2);

[h,p5]=ttest(pow_comb3_da_cv,pow_comb3_ta_cv);  
...
pow_comb3_da_max=mean(pow_comb3(:,[3,9]),2);
pow_comb3_ta_max=mean(pow_comb3(:,[6 12]),2);

[h,p6]=ttest(pow_comb3_da_max,pow_comb3_ta_max);
...
pow_comb3_disc=mean(pow_comb3(:,1:6),2);
pow_comb3_white=mean(pow_comb3(:,7:12),2);
pow_comb3_cont=mean(pow_comb3(:,[13 14]),2);

pow_comb3_1=[pow_comb3_disc,pow_comb3_white,pow_comb3_cont];

p7=anova1(pow_comb3_1,groups_1);
...
pow_comb3_0=mean(pow_comb3(:,[1 4 7 10]),2);
pow_comb3_cv=mean(pow_comb3(:,[2 5 8 11]),2);
pow_comb3_maxmp=mean(pow_comb3(:,[3 6 9 12]),2);

pow_comb3_loc=[pow_comb3_0,pow_comb3_cv,pow_comb3_maxmp,pow_comb3_cont];

groups2={'onset','cv','maxamp','control'};

p8=anova1(pow_comb3_loc,groups2);
...
itc_disc_onset=mean(pow_comb3(:,[1,4]),2);
itc_white_onset=mean(pow_comb3(:,[7,10]),2);
itc_control=mean(pow_comb3(:,13:14),2);
...
itc_disc_cv=mean(pow_comb3(:,[2,5]),2);
itc_white_cv=mean(pow_comb3(:,[8,11]),2);
...
[h,p]=ttest(itc_disc_cv,itc_white_cv);   
...
itc_disc_max=mean(pow_comb3(:,[3,6]),2);
itc_white_max=mean(pow_comb3(:,[9,12]),2);
...
itc_da_disc=mean(pow_comb3(:,1:3),2);
itc_da_white=mean(pow_comb3(:,7:9),2);

groups_da_noise={'da disc', 'da white', 'da control'};

p12=anova1([itc_da_disc,itc_da_white,pow_comb3(:,13)], groups_da_noise);
...
itc_ta_disc=mean(pow_comb3(:,4:6),2);
itc_ta_white=mean(pow_comb3(:,10:12),2);

groups_ta_noise={'da disc', 'da white', 'da control'};

p13=anova1([itc_ta_disc,itc_ta_white,pow_comb3(:,13)], groups_ta_noise);
...
itc_da_onset=mean(pow_comb3(:,[1 7]),2);
itc_da_cv=mean(pow_comb3(:,[2 8]),2);
itc_da_maxamp=mean(pow_comb3(:,[3 9]),2);

groups_da_location={'da onset', 'da cv', 'da maxamp', 'da control'};

p14=anova1([itc_da_onset,itc_da_cv,itc_da_maxamp,pow_comb3(:,13)], groups_da_location);
...
itc_ta_onset=mean(pow_comb3(:,[4 10]),2);
itc_ta_cv=mean(pow_comb3(:,[5 11]),2);
itc_ta_maxamp=mean(pow_comb3(:,[6 12]),2);

groups_ta_location={'ta onset', 'ta cv', 'ta maxamp', 'ta control'};

p15=anova1([itc_ta_onset,itc_ta_cv,itc_ta_maxamp,pow_comb3(:,13)], groups_ta_location);
...
[h,p]=ttest(itc_ta_onset,pow_comb3(:,13));
...
itc_disc_0=mean(pow_comb3(:,[1,4]),2);
itc_disc_cv=mean(pow_comb3(:,[2,5]),2);
itc_disc_maxamp=mean(pow_comb3(:,[3,6]),2);
...
itc_white_0=mean(pow_comb3(:,[7,10]),2);
itc_white_cv=mean(pow_comb3(:,[8,11]),2);
itc_white_maxamp=mean(pow_comb3(:,[9,12]),2);
...
p18=anova1(pow_comb3(:,[1 2 3 13]), groups_da_disc);
...
p19=anova1(pow_comb3(:,[4 5 6 14]), groups_ta_disc);
...
p20=anova1(pow_comb3(:,[7 8 9 13]), groups_da_white);
...
p21=anova1(pow_comb3(:,[10 11 12 14]), groups_ta_white);
...
p22=anova1(pow_comb3(:,[1 7 13]), groups_da_0);
...
[h,p]=ttest(pow_comb3(:,1),pow_comb3(:,7));
...
p23=anova1(pow_comb3(:,[2 8 13]), groups_da_cv);
...
[h,p]=ttest(pow_comb3(:,2),pow_comb3(:,8));
...
p24=anova1(pow_comb3(:,[3 9 13]), groups_da_max_amp);
...
[h,p]=ttest(pow_comb3(:,3),pow_comb3(:,9));
...
p25=anova1(pow_comb3(:,[4 10 14]), groups_ta_0);
...
[h,p]=ttest(pow_comb3(:,4),pow_comb3(:,10));
...
p26=anova1(pow_comb3(:,[5 11 14]), groups_ta_cv);
...
[h,p]=ttest(pow_comb3(:,5),pow_comb3(:,11));
...
p27=anova1(pow_comb3(:,[6 12 14]), groups_ta_max_amp);
...
[h,p]=ttest(pow_comb3(:,6),pow_comb3(:,12));
